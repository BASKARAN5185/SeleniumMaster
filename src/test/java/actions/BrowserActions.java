...
public class BrowserActions {
	...
	public static String getTextAction(String locatorType,String locatorValue) {
		By byvalue = LocatorsOptions.locatorType(locatorType, locatorValue);
		String textvalue = Configuration.driver.findElement(byvalue).getText();
		return textvalue;
	}
	
	public static String getAttributeValueAction(String locatorType,String locatorValue,String attribute) {
		By byvalue = LocatorsOptions.locatorType(locatorType, locatorValue);
